use jord::{Error, HorizontalPos, Microarcsecond};

#[test]
fn intermediate_pos_to_err() {
    let p1 = HorizontalPos::from_s84(44.0, 44.0);
    let p2 = HorizontalPos::from_s84(46.0, 46.0);
...
fn intermediate_pos_to() {
    let p1 = HorizontalPos::from_s84(53.479444, -2.245278);
    let p2 = HorizontalPos::from_s84(55.605833, 13.035833);
    let pe = HorizontalPos::from_s84(54.78355703138889, 5.194985318055555);
    assert_eq!(
        pe,
        p1.intermediate_pos_to(p2, 0.5)
            .unwrap()
