...
fn p1() -> HorizontalPos<S84Model> {
    HorizontalPos::from_s84(45.0, 1.0)
}

fn p2() -> HorizontalPos<S84Model> {
    HorizontalPos::from_s84(45.0, 2.0)
}

fn p3() -> HorizontalPos<S84Model> {
    HorizontalPos::from_s84(46.0, 1.0)
}

fn p4() -> HorizontalPos<S84Model> {
    HorizontalPos::from_s84(46.0, 2.0)
}

fn p5() -> HorizontalPos<S84Model> {
    HorizontalPos::from_s84(45.1, 1.1)
}
