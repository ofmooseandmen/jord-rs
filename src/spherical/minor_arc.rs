...
impl MinorArc {
    ...
    /// Computes the [chord length](crate::spherical::ChordLength) between the given position and the closest point on this minor
    /// arc of great circle from that position.
